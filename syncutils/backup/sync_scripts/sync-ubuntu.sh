...
LFTP_SRC="http://mirrors.tuna.tsinghua.edu.cn/ubuntu"
# LFTP_SRC="http://ftp.sjtu.edu.cn/ubuntu"

# RSYNC_SRC="rsync://mirrors.ustc.edu.cn/ubuntu"
RSYNC_SRC="rsync://mirrors.4.tuna.tsinghua.edu.cn/ubuntu"
RSYNC_SRC_IPv6="rsync://mirrors.6.tuna.tsinghua.edu.cn/ubuntu"
# RSYNC_SRC="rsync://202.38.95.110/ubuntu" # ip of ustc
# RSYNC_SRC_IPv6="rsync://mirrors.ustc.edu.cn/ubuntu"
# RSYNC_SRC="rsync://mirror.bjtu.edu.cn/ubuntu"
# RSYNC_SRC_IPv6="rsync://mirror6.bjtu.edu.cn/ubuntu"
...
LFTP_DELETE="--delete"
LFTP_EXCLUDE="--exclude-glob .* --exclude-glob Archive-Update-in-Process*"
...
RSYNC_EXCLUDE="--exclude=.* --exclude=Archive-Update-in-Process*"
...
if [ ${SYNC_RETURN_CODE} == 0 ] ; then
    echo "$(date --utc)" > ${SYNC_DEST}/project/trace/ftp.nankai.edu.cn
