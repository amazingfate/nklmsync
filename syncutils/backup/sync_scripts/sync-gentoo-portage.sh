...
# ================= Configuration Begin ===================
SYNC_SYS="gentoo-portage"

# Filesystem locations for the sync operations
SYNC_DEST="/ftp/ftp/gentoo-portage"
...
LFTP_SRC="http://mirrors.tuna.tsinghua.edu.cn/gentoo-portage"

RSYNC_SRC="rsync://mirrors.4.tuna.tsinghua.edu.cn/gentoo-portage"
RSYNC_SRC_IPv6="rsync://mirrors.6.tuna.tsinghua.edu.cn/gentoo-portage"
# RSYNC_SRC="rsync://202.38.95.110/gentoo-portage" # ip of ustc
# RSYNC_SRC_IPv6="rsync://mirrors.ustc.edu.cn/gentoo-portage"
# RSYNC_SRC="rsync://mirror.bjtu.edu.cn/gentoo-portage"
# RSYNC_SRC_IPv6="rsync://mirror6.bjtu.edu.cn/gentoo-portage"
