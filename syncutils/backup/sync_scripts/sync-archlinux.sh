...
LFTP_SRC="http://mirrors.tuna.tsinghua.edu.cn/archlinux"
# LFTP_SRC="http://ftp.sjtu.edu.cn/archlinux"

RSYNC_SRC="rsync://mirrors.4.tuna.tsinghua.edu.cn/archlinux"
RSYNC_SRC_IPv6="rsync://mirrors.6.tuna.tsinghua.edu.cn/archlinux"
# RSYNC_SRC="rsync://mirrors.ustc.edu.cn/archlinux"
# RSYNC_SRC="rsync://202.38.95.110/archlinux" # ip of ustc
# RSYNC_SRC_IPv6="rsync://mirrors6.ustc.edu.cn/archlinux"
# RSYNC_SRC="rsync://mirror.bjtu.edu.cn/archlinux"
# RSYNC_SRC_IPv6="rsync://mirror6.bjtu.edu.cn/archlinux"
...
LFTP_DELETE="--delete"
LFTP_EXCLUDE="--exclude-glob .* --exclude iso/ --exclude-glob Archive-Update-in-Process*"
...
RSYNC_EXCLUDE="--exclude=.* --exclude=/iso/ --exclude=Archive-Update-in-Process*"
...
if [ ${SYNC_RETURN_CODE} == 0 ] ; then
    echo "$(date +%s)" > ${RSYNC_DEST}/lastsync
