...
LFTP_SRC="http://mirrors.tuna.tsinghua.edu.cn/centos/"

RSYNC_SRC="rsync://mirrors.4.tuna.tsinghua.edu.cn/centos"
RSYNC_SRC_IPv6="rsync://mirrors.6.tuna.tsinghua.edu.cn/centos"
# RSYNC_SRC="rsync://mirrors.ustc.edu.cn/centos"
# RSYNC_SRC="rsync://202.38.95.110/centos" # ip of ustc
# RSYNC_SRC_IPv6="rsync://mirrors.ustc.edu.cn/centos"
...
LFTP_DELETE="--delete"
LFTP_EXCLUDE="--exclude-glob .* --exclude 2/ --exclude 2.1/ --exclude 3/ --exclude 3.1/ --exclude 3.2/ --exclude 3.3/ --exclude 3.4/ --exclude 3.5/ --exclude 3.6/ --exclude 3.7/ --exclude 3.8/ --exclude 3.9/ --exclude RPM-GPG-KEY-CentOS-3 --exclude */isos/"
...
RSYNC_EXCLUDE="--exclude=.* --exclude=2 --exclude=2.1 --exclude=3 --exclude=3.1 --exclude=3.2 --exclude=3.3 --exclude=3.4 --exclude=3.5 --exclude=3.6 --exclude=3.7 --exclude=3.8 --exclude=3.9 --exclude=RPM-GPG-KEY-CentOS-3 --exclude=*/isos"
...
if [ ${SYNC_RETURN_CODE} == 0 ] ; then
    echo "$(date +%s)" > ${RSYNC_DEST}/TIME
    echo "$(date --utc)" > ${RSYNC_DEST}/timestamp.txt
