...
# LFTP_SRC="http://mirrors.tuna.tsinghua.edu.cn/epel"

RSYNC_SRC="rsync://mirrors.4.tuna.tsinghua.edu.cn/epel"
RSYNC_SRC_IPv6="rsync://mirrors.6.tuna.tsinghua.edu.cn/epel"
...
RSYNC_EXCLUDE="--exclude=.* --exclude=/4/ --exclude=/4AS --exclude=/4ES --exclude=/4WS --exclude=/testing/4/ --exclude=/testing/4AS --exclude=/testing/4ES --exclude=/testing/4WS --exclude=Archive-Update-in-Process*"
