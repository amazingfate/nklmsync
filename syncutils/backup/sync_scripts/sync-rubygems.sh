...
SYNC_DEST="/ftp/ftp/rubygems"
SYNC_LOG_DIR="/ftp/syncutils/sync_logs"

# Set the format of the log file name(e.g. rubygems_19700101-08.log)
...
LFTP_SRC="http://mirrors.tuna.tsinghua.edu.cn/rubygems"

RSYNC_SRC="rsync://mirrors.4.tuna.tsinghua.edu.cn/rubygems"
RSYNC_SRC_IPv6="rsync://mirrors.6.tuna.tsinghua.edu.cn/rubygems"
