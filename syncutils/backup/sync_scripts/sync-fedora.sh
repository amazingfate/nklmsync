...
# LFTP_SRC="http://mirrors.tuna.tsinghua.edu.cn/fedora"
LFTP_SRC="http://ftp.sjtu.edu.cn/fedora/linux"

RSYNC_SRC="rsync://mirrors.4.tuna.tsinghua.edu.cn/fedora"
RSYNC_SRC_IPv6="rsync://mirrors.6.tuna.tsinghua.edu.cn/fedora"
# RSYNC_SRC="rsync://ftp.sjtu.edu.cn/fedora-enchilada0"
# RSYNC_SRC="rsync://mirrors.ustc.edu.cn/fedora-enchilada"
# RSYNC_SRC="rsync://202.38.95.110/fedora-enchilada" # ip of ustc
# RSYNC_SRC_IPv6="rsync://mirrors.ustc.edu.cn/fedora-enchilada"
...
LFTP_DELETE="--delete"
LFTP_EXCLUDE="--exclude-glob .* --exclude core/ --exclude releases/7/ --exclude releases/8/ --exclude releases/9/ --exclude updates/8/ --exclude updates/9/ --exclude updates/testing/7/ --exclude updates/testing/8/ --exclude updates/testing/9/ --exclude-glob Archive-Update-in-Process*"
...
RSYNC_EXCLUDE="--exclude=.* --exclude=*.iso --exclude=/core/ --exclude=/releases/7/ --exclude=/releases/8/ --exclude=/releases/9/ --exclude=/updates/8/ --exclude=/updates/9/ --exclude=/updates/testing/7/ --exclude=/updates/testing/8/ --exclude=/updates/testing/9/ --exclude=Archive-Update-in-Process*"
